...
title-slide-attributes:
  data-background-image: "plot/reg-analysis-title-page.png"
...
```{r}
knitr::include_graphics("plot/OLS fit.png")
```
...
```{r}
knitr::include_graphics("plot/econ148-hex-logo.png")
```
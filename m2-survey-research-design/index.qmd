...
## working directory
setwd("C:/Users/chris/Documents/Github-repository/econ115a-lectures/m2-survey-research-design")
...
## What distinguishes primary data from secondary data? {.quiz-question}

- Primary data is always quantitative

- Secondary data is collected through interviews

- [Primary data is collected firsthand by the researcher]{.correct data-explanation="Correct! Primary data is gathered directly by the researcher for a specific purpose, while secondary data is pre-existing."}

- Secondary data is more reliable



## Which tool is most appropriate for collecting qualitative data? {.quiz-question}

- Structured questionnaire

- Laboratory experiment

- [Open-ended interview]{.correct data-explanation="Correct! Open-ended interviews allow for rich, descriptive responses ideal for qualitative analysis."}

- Online survey with multiple choice



## What is a key advantage of using structured questionnaires? {.quiz-question}

- They allow for spontaneous responses

- [They reduce interviewer bias]{.correct data-explanation="Correct! Structured questionnaires standardize the data collection process, minimizing interviewer influence."}

- They are ideal for exploratory research

- They require no pre-testing

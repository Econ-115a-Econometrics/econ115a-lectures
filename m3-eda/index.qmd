...
## working directory
setwd("C:/Users/chris/Documents/Github-repository/econ115a-lectures/m3-eda")
...
::: {.notes}
1. (a) The untransformed plot shows extreme compression - nearly all counties are squeezed into the left side near 0. This makes it impossible to see patterns or relationships for the vast majority of counties
...
- 
  - A dot plot is a one-variable scatterplot; an example
 using the interest rate of 50 loans above.
